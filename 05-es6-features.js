...
const [highest, second, third = 92, ...remainingScores] = scores;
...
function createReport(title, author = 'Deepu', ...sections) {
    return {
        title: title,
        author: author,
        sections: [...sections],
...
const square = x => x**2;                    // Single parameter, implicit return
