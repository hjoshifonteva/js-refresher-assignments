...
console.log('Report:', createReport('Q2 Summary', 'John Doe', 'Sales', 'Finance', 'Operations'));
...
// Test enhanced object literal
console.log('Calculator Info:', calculatorApp.getInfo());
console.log('Calculator Add 2+3:', calculatorApp.add(2, 3));
console.log('Calculator Multiply 3x4:', calculatorApp.multiply(3, 4));

// Test analyzeData
const dataset = [
    { name: 'Item A', value: 45, tag: 'alpha' },
    { name: 'Item B', value: 30 },
    { name: 'Item C', value: 70, extra: true },
    { name: 'Item D', value: 60 }
];

console.log('Analyzed Data:', analyzeData(dataset, { filterMin: 40, sortBy: 'value', limit: 3 }));

// Test tagged template
const lang = 'JavaScript';
const level = 'Advanced';
console.log('Highlight:', highlight`Course: ${lang}, Level: ${level}`);
